				...
				<div class="tiny-slider arrow-round arrow-blur arrow-hover rounded-3 overflow-hidden">
					<div class="tiny-slider-inner" data-autoplay="false" data-gutter="0" data-arrow="true" data-dots="false" data-items="1">
						...
						<div class="card overflow-hidden h-500px h-md-600px text-center rounded-0" style="background-image:url(assets/images/bg/02.jpg); background-position: center left; background-size: cover;">
							...
							<div class="bg-overlay bg-dar<!-- Card image overlay -->
						...
						<div class="card border mb-1 bg-transparent">
							...
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-center mt-n6 mb-3">
									...
									<!-- Badge -->
									<div class="h5 mb-0"><a href="#" class="badge text-bg-danger">Admission Closed</a></div>
								</div>
								<!-- Badge and rating -->
					...
					<div>
						<div class="card border mb-1 bg-transparent">
							...
							<div class="card-body">
								...
								<div class="d-flex justify-content-between mb-3">
									<!-- Badge -->
									<span><a href="#" class="badge text-bg-dark">Public</a></span>
									<!-- Rating star -->
									<ul class="list-inline hstack mb-0">
										<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
										<li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
		...
		<div class="row mb-4">
			<div class="d-md-flex justify-content-md-between align-items-center">
				...
				<div>
					...
					<a href="#" class="btn btn-sm btn-primary-soft mb-0">Go here<i class="fas fa-angle-right ms-2"></i></a>
				</div>
			</div>
		</div>
			...
			<div class="col-md-6 col-lg-8">
				<div class="row g-4">
					<div class="col-lg-7">
						...
						<div class="card bg-transparent">
							<div class="overflow-hidden rounded-3">
								<img src="assets/images/event/01.jpg" class="card-imgp" alt="Card image">
								<!-- Overlay -->
								<div class="bg-overlay bg-dark opacity-4"></div>
								<div class="card-img-overlay d-flex align-items-start flex-column p-3">
									<!-- badge -->
