    ...
    <nav class="navbar navbar-expand-xl">
        <div class="container">
            ...
            <a class="navbar-brand" href="{{route('index')}}">
                <img class="light-mode-item navbar-brand-item" src="assets/images/log.svg" alt="ISIC">
                <img class="dark-mode-item navbar-brand-item" src="assets/images/log-light.svg" alt="ISIC">
            </a>
                ...
                <ul class="navbar-nav navbar-nav-scroll mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="demoMenu">
                            ...
                            <li> <a class="dropdown-item active" href="index-5.html">Home University</a></li>
